...
#
# Generated by export_simulation on Fri Jan 11 12:54:34 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './state_test5.sh' script.

./state_test5.sh -reset_run
...
./state_test5.sh -noclean_files

For more information on the script, please type './state_test5.sh -help'.
