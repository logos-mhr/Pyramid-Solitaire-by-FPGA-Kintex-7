...
#
# Generated by export_simulation on Thu Jan 10 21:24:57 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './C1.sh' script.
...
For more information on the script, please type './C1.sh -help'.
