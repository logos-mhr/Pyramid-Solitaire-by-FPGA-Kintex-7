...
#
# Generated by export_simulation on Thu Jan 10 19:29:07 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './startP.sh' script.
...
./startP.sh -noclean_files

For more information on the script, please type './startP.sh -help'.
