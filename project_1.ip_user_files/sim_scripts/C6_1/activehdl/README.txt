...
#
# Generated by export_simulation on Thu Jan 10 22:46:40 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './C6.sh' script.
...
For more information on the script, please type './C6.sh -help'.
