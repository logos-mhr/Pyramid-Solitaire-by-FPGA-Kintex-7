...
#
# Generated by export_simulation on Wed Jan 02 16:46:38 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './first.sh' script.
...
./first.sh -noclean_files

For more information on the script, please type './first.sh -help'.
