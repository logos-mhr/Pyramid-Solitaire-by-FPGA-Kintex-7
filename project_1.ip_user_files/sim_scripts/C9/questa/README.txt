...
#
# Generated by export_simulation on Thu Jan 10 22:49:38 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './C9.sh' script.
...
For more information on the script, please type './C9.sh -help'.
