...
#
# Generated by export_simulation on Thu Jan 10 21:27:47 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './C3.sh' script.
...
For more information on the script, please type './C3.sh -help'.
