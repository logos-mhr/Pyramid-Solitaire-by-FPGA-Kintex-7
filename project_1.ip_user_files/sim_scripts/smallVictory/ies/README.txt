...
#
# Generated by export_simulation on Fri Jan 11 01:53:16 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './smallVictory.sh' script.

./smallVictory.sh -reset_run
...
./smallVictory.sh -noclean_files

For more information on the script, please type './smallVictory.sh -help'.
