...
#
# Generated by export_simulation on Wed Jan 02 16:59:17 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './reference.sh' script.

./reference.sh -reset_run
...
./reference.sh -noclean_files

For more information on the script, please type './reference.sh -help'.
