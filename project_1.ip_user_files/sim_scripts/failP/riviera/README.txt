...
#
# Generated by export_simulation on Thu Jan 10 19:31:19 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './failP.sh' script.
...
./failP.sh -noclean_files

For more information on the script, please type './failP.sh -help'.
