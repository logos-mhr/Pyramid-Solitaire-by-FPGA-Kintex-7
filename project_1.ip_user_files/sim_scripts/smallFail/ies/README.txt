...
#
# Generated by export_simulation on Fri Jan 11 01:51:13 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './smallFail.sh' script.

./smallFail.sh -reset_run
...
./smallFail.sh -noclean_files

For more information on the script, please type './smallFail.sh -help'.
