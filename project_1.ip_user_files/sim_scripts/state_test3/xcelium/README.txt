...
#
# Generated by export_simulation on Mon Jan 07 20:05:14 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './state_test3.sh' script.

./state_test3.sh -reset_run
...
./state_test3.sh -noclean_files

For more information on the script, please type './state_test3.sh -help'.
