...
#
# Generated by export_simulation on Tue Jan 08 18:18:44 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './state_test4.sh' script.

./state_test4.sh -reset_run
...
./state_test4.sh -noclean_files

For more information on the script, please type './state_test4.sh -help'.
