...
#
# Generated by export_simulation on Thu Jan 10 22:48:41 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './C8.sh' script.
...
For more information on the script, please type './C8.sh -help'.
