...
#
# Generated by export_simulation on Sun Jan 06 13:45:03 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './function1.sh' script.

./function1.sh -reset_run
...
./function1.sh -noclean_files

For more information on the script, please type './function1.sh -help'.
