...
#
# Generated by export_simulation on Thu Jan 10 19:33:39 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './victoryP.sh' script.

./victoryP.sh -reset_run
...
./victoryP.sh -noclean_files

For more information on the script, please type './victoryP.sh -help'.
