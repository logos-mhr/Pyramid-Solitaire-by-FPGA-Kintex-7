...
#
# Generated by export_simulation on Mon Jan 07 18:31:29 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './state_test2.sh' script.

./state_test2.sh -reset_run
...
./state_test2.sh -noclean_files

For more information on the script, please type './state_test2.sh -help'.
