...
#
# Generated by export_simulation on Thu Jan 10 22:42:41 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './C5.sh' script.
...
For more information on the script, please type './C5.sh -help'.
