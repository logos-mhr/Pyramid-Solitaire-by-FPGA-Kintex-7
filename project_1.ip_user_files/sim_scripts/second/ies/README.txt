...
#
# Generated by export_simulation on Wed Jan 02 16:49:32 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './second.sh' script.
...
./second.sh -noclean_files

For more information on the script, please type './second.sh -help'.
