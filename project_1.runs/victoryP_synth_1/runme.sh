...
HD_PWD='C:/Users/logos/project_1/project_1.runs/victoryP_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log victoryP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source victoryP.tcl
