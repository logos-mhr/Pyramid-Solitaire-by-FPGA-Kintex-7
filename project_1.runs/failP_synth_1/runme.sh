...
HD_PWD='C:/Users/logos/project_1/project_1.runs/failP_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log failP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source failP.tcl
