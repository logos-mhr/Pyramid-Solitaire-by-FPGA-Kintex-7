...
HD_PWD='C:/Users/logos/project_1/project_1.runs/C52_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log C52.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source C52.tcl
