...
HD_PWD='C:/Users/logos/project_1/project_1.runs/C40_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log C40.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source C40.tcl
