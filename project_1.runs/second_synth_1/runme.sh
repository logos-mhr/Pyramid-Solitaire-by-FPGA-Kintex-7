...
HD_PWD='C:/Users/logos/project_1/project_1.runs/second_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log second.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source second.tcl
