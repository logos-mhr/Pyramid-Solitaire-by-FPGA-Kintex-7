...
HD_PWD='C:/Users/logos/project_1/project_1.runs/C6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log C6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source C6.tcl
