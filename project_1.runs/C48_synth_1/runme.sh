...
HD_PWD='C:/Users/logos/project_1/project_1.runs/C48_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log C48.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source C48.tcl
