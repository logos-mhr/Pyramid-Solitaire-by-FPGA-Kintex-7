...
HD_PWD='C:/Users/logos/project_1/project_1.runs/C35_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log C35.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source C35.tcl
