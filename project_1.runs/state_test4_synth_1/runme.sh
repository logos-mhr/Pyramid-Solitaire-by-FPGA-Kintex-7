...
HD_PWD='C:/Users/logos/project_1/project_1.runs/state_test4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log state_test4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source state_test4.tcl
