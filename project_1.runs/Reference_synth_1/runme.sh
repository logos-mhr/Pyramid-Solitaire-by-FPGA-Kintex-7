...
HD_PWD='C:/Users/logos/project_1/project_1.runs/Reference_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Reference.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Reference.tcl
