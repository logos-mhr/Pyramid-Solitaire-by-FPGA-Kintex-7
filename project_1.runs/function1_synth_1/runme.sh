...
HD_PWD='C:/Users/logos/project_1/project_1.runs/function1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log function1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source function1.tcl
